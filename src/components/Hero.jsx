    ...
    >
        ...
        ref={parallaxRef}>
            ...
            lg:mb:[6rem]">
                ...
                text-n-2 lg:mb-8"
                >Unleash power of AI within Brainwave.
                ...
                <div className="relative bg-n-8 rounded-[1-rem]">
                  ...
                  lg:aspect-[1024/490]">
                    ...
                    <ScrollParallax isAbsolutelyPositioned>
                      ...
                      bottom-[7.5rem] px-1 py-1 bg-n-9
            ...
            <CompanyLogos className="hiden relative z-10
            mt-20 lg:block" />
