    ...
    <Section id="how-to-use">
        <div className="container">
            ...
            <div className="relative">
                <div className="relative z-1 felx items-center
                h-[39rem] mb-5 p-8 border border-n-1/10
                rouded-3xl overflow-hidden lg:p-20 xl:h-[46rem]
                ">
                    ...
                    ml-auto">
                        ...
                        <p className="body-2 mb-[3rem] text-n-3">
                          Brainwave ulocks the potential of
                          AI-powered applications
                        </p>
                        <ul className="body-2">
                ...
                lg:grid-cols-2">
                  ...
                  border border-n-1/10 rouded-3xl
                  overflow-hidden-">
                  ...
                  <div className="p-4 bg-n-7 rouded-3xl overflow-hidden
                  lg:min-h-[46rem]">
                    <div className="py-12 px-4 xl:px-8">
                      ...
                      justify-between">
                        {brainwaveServicesIcons.map((item,index)=>(
                          ...
                          :'flex w-10 h-10 bg-n-6 md:w-15 md:g-15'}`}>
